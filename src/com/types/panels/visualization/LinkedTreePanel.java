...
public class LinkedTreePanel extends Standard {
	...
	public void renderComponents() {
		...
		whereUser = Inputs.createComboBox("Nodo raiz", generateList());
		valueUser = Inputs.createField("Nodo folha:", 20, JTextField.CENTER, Object.class);
	}
