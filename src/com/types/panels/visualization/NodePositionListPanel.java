...
public class NodePositionListPanel extends Standard {
	...
	public void renderComponents() {
		...
		listNodes = Inputs.createComboBox("Do nodo:", generateList());
		...
		whereUser = Inputs.createComboBox("Colocar:", options);
